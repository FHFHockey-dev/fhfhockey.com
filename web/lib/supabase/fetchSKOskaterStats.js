...
// C:\Users\timbr\OneDrive\Desktop\fhfhockey.com-1\web\lib\supabase\fetchSKOskaterStats.js
...
// NEXT_PUBLIC_SUPABASE_PUBLIC_KEY="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ5aGZ0bHhva3lqdHBuZGJrZnNlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTAzODI4OTgsImV4cCI6MjAyNTk1ODg5OH0.J2YsCINxTGLd0OZYBYH-87inK0vOBTAij35tTXrYnYw"
...
async function fetchNHLSkaterData() {
  ...
  while (
    ...
    skaterStats.forEach(async (stat, index) => {
      ...
      const response = await supabase.from("sko_skater_stats").upsert({
