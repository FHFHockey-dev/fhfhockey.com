...
const GOALIE_COUNTS_COLUMNS: readonly PlayerStatsColumnDefinition[] = [
  ...
  metric("xgAgainst", "xG Against", "decimal"),
  ...
  metric("hdSavePct", "HDSV%", "percentage"),
  metric("hdGaa", "HDGAA", "decimal"),
  metric("hdGsaa", "HDGSAA", "decimal"),
  ...
  metric("mdSavePct", "MDSV%", "percentage"),
  metric("mdGaa", "MDGAA", "decimal"),
  metric("mdGsaa", "MDGSAA", "decimal"),
  ...
  metric("ldSavePct", "LDSV%", "percentage"),
  metric("ldGaa", "LDGAA", "decimal"),
  metric("ldGsaa", "LDGSAA", "decimal"),
