...
function ShotMap() {
  ...
  async function fetchGameData(date) {
    ...
    response.gameWeek.forEach(week => {
      week.games.forEach(async game => {
        ...
        const playDataResponse = await Fetch(`https://api-web.nhle.com/v1/gamecenter/${game.id}/play-by-play`)
          .then(res => res.json());
  ...
  function extractPlayDetails(plays) {
    ...
    const relevantPlays = plays.filter(play => play.typeDescKey === 'shot-on-goal' || play.typeDescKey === 'goal');
  ...
  function aggregateDataIntoHeatMaps() {
    ...
    Object.values(playData).flat().forEach(play => {
      const { svgX, svgY } = convertToSVGCoordinates(play.xCoord, play.yCoord);
      const xIndex = Math.floor(svgX / (iceSurfaceWidth / heatMapResolution.x));
      const yIndex = Math.floor(svgY / (iceSurfaceHeight / heatMapResolution.y));

      if (xIndex >= 0 && xIndex < heatMapResolution.x && yIndex >= 0 && yIndex < heatMapResolution.y) {
  ...
  function getColorForDensity(density, isGoal = false) {
    const maxDensity = Math.max(...(isGoal ? goalsHeatMap : shotsHeatMap).flat());
    ...
    return isGoal ? `rgba(0, 0, 255, ${opacity})` : `rgba(255, 0, 0, ${opacity})`; // Blue for goals, red for shots
  }
  ...
  const renderHeatMap = () => {
    ...
    return (
      shotsHeatMap.flatMap((row, yIndex) =>
        row.map((shots, xIndex) => {
          ...
          const goalPoints = goals > 0 ? hexagonPoints(centerX, centerY, hexagonSize * 0.5) : null;
  
          return (
            <React.Fragment key={`${xIndex}-${yIndex}`}>
              <polygon points={shotPoints} fill={getColorForDensity(shots)} 
                onMouseEnter={(e) => handleMouseEnter(e, xIndex, yIndex, shots, goals)}
                onMouseLeave={handleMouseLeave}
              />
              {goalPoints && <polygon points={goalPoints} fill={getColorForDensity(goals, true)} />}
            </React.Fragment>
          );
        })
      )
  ...
  return (
    <div className={styles.container}>
      <div className={styles.contentAbove}>
        <p>{startDate ? `Regular Season Start Date: ${startDate}` : 'Loading...'}</p>
        {!fetching && <p>Finished collecting Game IDs for {startDate} to {endDate}</p>}
      </div>
        <svg id="ice-hockey-svg" xmlns="http://www.w3.org/2000/svg" className={styles.hockeyRink} viewBox="0 0 202 87">
          <g id="transformations">
            ...
            <path id="center-line" d="M 100 0
                  L 100 85" stroke="#C8102e" strokeWidth="1"/>
            <path
            ...
            <g id="goal-lines">
              <path id="left-goal-line" d="M 11 6
                    L 11 79" stroke="#C8102e" strokeWidth="0.166667"/>
              <path id="right-goal-line" d="M 189 6
                    L 189 79" stroke="#C8102e" strokeWidth="0.166667"/>
            </g>
            <g id="goal-creases">
              <g id="left-goalie-crease">
                <path d="
                          ...
                          L 11 53.5
                          M 0 28.5
                          L 11 31.5" stroke="#C8102e" strokeWidth="0.1667"/>
                <path
                  id="left-goal-crease"
                  d="
                          M 11 38.5
                ...
                <path id="left-goal" d="
                          ...
                          L 9 39.5
                          A 5 5 0 0 0 9 45.5
                          L 11 45.5" stroke="black" fill="transparent" strokeWidth="0.1667"/>
              </g>
              <g id="right-goalie-crease">
                <path d="
                          ...
                          L 189 53.5
                          M 200 28.5
                          L 189 31.5" stroke="#C8102e" strokeWidth="0.1667"/>
                <path
                ...
                <path id="right-goal" d="
                          ...
                          L 189 45.5" stroke="black" fill="transparent" strokeWidth="0.1667"/>
              </g>
            </g>
            <g id="blue-lines">
              <path id="left-blue-line" d="M 75 0
                  L 75 85" stroke="#0033A0" strokeWidth="1"/>
              <path id="right-blue-line" d="M 125 0
                  L 125 85" stroke="#0033A0" strokeWidth="1"/>
            </g>
            <g id="center-faceoff-spots">
              <circle id="top-left-spot" cx="80" cy="20.5" r="1" stroke="#C8102e" strokeWidth="0.1667" fill="transparent"/>
              <rect x="79.4" y="19.57" width="1.2" height="1.85" fill="#C8102e"/>
              <circle id="top-right-spot" cx="120" cy="20.5" r="1" stroke="#C8102e" strokeWidth="0.1667" fill="transparent"/>
              <rect x="119.4" y="19.57" width="1.2" height="1.85" fill="#C8102e"/>
              <circle id="bottom-left-spot" cx="80" cy="64.5" r="1" stroke="#C8102e" strokeWidth="0.1667" fill="transparent"/>
              <rect x="79.4" y="63.57" width="1.2" height="1.85" fill="#C8102e"/>
              <circle id="bottom-right-spot" cx="120" cy="64.5" r="1" stroke="#C8102e" strokeWidth="0.1667" fill="transparent"/>
              <rect x="119.4" y="63.57" width="1.2" height="1.85" fill="#C8102e"/>
            </g>
            <g id="center-circles">
              <circle id="outer-center-circle" cx="100" cy="42.5" r="15" stroke="#0033A0" strokeWidth="0.1666667" fill="transparent"/>
              <circle id="middle-center-circle" cx="100" cy="42.5" r=".5" fill="#0033A0"/>
            </g>
            <g id="faceoff-circles">
              <g id="bottom-left-faceoff-circle">
                <circle id="center-circle" cx="31" cy="64.5" r="1" stroke="#C8102e" strokeWidth="0.1667" fill="transparent"/>
                <rect x="30.4" y="63.57" width="1.2" height="1.85" fill="#C8102e"/>
                <circle id="center-circle" cx="31" cy="64.5" r="15" stroke="#C8102e" fill="transparent" strokeWidth=".16667"/>
                <path
                  d="
                    M 28.125 49.75
                    L 28.125 47.75
              ...
              <g id="bottom-right-faceoff-circle">
                <circle id="center-circle" cx="169" cy="64.5" r="1" stroke="#C8102e" strokeWidth="0.1667" fill="transparent"/>
                <rect x="168.4" y="63.57" width="1.2" height="1.85" fill="#C8102e"/>
                <circle id="center-circle" cx="169" cy="64.5" r="15" stroke="#C8102e" fill="transparent" strokeWidth=".16667"/>
                <path
                  d="
                    M 166.125 49.75
                    L 166.125 47.75
              ...
              <g id="top-right-faceoff-circle">
                <circle id="center-circle" cx="169" cy="20.5" r="1" stroke="#C8102e" strokeWidth="0.1667" fill="transparent"/>
                <rect x="168.4" y="19.57" width="1.2" height="1.85" fill="#C8102e"/>
                <circle id="center-circle" cx="169" cy="20.5" r="15" stroke="#C8102e" fill="transparent" strokeWidth=".16667"/>
                <path
                  d="
                    M 166.125 5.75
                    L 166.125 3.75
              ...
              <g id="top-left-faceoff-circle">
                <circle id="center-circle" cx="31" cy="20.5" r="1" stroke="#C8102e" strokeWidth="0.1667" fill="transparent"/>
                <rect x="30.4" y="19.57" width="1.2" height="1.85" fill="#C8102e"/>
                <circle id="center-circle" cx="31" cy="20.5" r="15" stroke="#C8102e" fill="transparent" strokeWidth=".16667"/>
                <path
                  d="
                    M 28.125 5.75
                    L 28.125 3.75
            ...
            <path id="scorekeeper" d="M 90 85 A 10 10 0 0 1 110 85" strokeWidth="0.16667" fill="transparent" stroke="#C8102e"/>
            <path
