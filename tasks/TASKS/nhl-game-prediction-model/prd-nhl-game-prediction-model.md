...
> You are helping implement an NHL Game Prediction Model and Analytics Platform for a website. Use the PRD in `/tasks/TASKS/nhl-game-prediction-model/prd-nhl-game-prediction-model.md` as the source of truth. The goal is to build a full prediction platform, but implementation should be phased. Start with research/audit and a reliable MVP game prediction pipeline before adding expensive complexity.
>
> Product goals:
