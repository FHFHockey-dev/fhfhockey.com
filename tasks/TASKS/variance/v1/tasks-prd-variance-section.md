...
- `tasks/TASKS/variance/v2/goalie-page-relevant-tables.md` - Read-only glossary of available goalie data fields to drive the Metrics tab expansion and relativity/value planning.
