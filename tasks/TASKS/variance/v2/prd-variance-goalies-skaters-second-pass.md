...
57. Update `tasks/TASKS/variance/v2/variance-runbook.md` with any implemented source, calculation, and fallback changes.
...
- Use documented skater schema fields from `tasks/TASKS/schema-docs/supabase-context/player-table-schemas.md` and `tasks/TASKS/schema-docs/supabase-context/supabase-table-structure.md`.
