...
- `tasks/TASKS/variance/v2/variance-runbook.md` - Durable data-flow and metric-maintenance runbook to update after implementation.
- `tasks/TASKS/variance/v2/goalie-page-relevant-tables.md` - Goalie schema glossary for advanced Metrics table field mapping.
- `tasks/TASKS/schema-docs/supabase-context/player-table-schemas.md` - Skater schema source for MVP table fields.
- `tasks/TASKS/schema-docs/supabase-context/supabase-table-structure.md` - Broader skater schema source for MVP table fields.
