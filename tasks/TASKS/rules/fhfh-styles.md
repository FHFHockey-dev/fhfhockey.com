...
If Codex is told to re-style a page "per `tasks/TASKS/rules/fhfh-styles.md`", it should treat this file as an implementation spec, not as loose inspiration.
...
5. update `tasks/TASKS/rules/fhfh-styles.md` with the final canonical rule
...
- If the visual rule changes, update `tasks/TASKS/rules/fhfh-styles.md`.
...
1. Confirm the family exists in the checklist and matrix in `tasks/TASKS/rules/fhfh-styles.md`.
