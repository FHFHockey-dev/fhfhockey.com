...
| B-SUST-BAR | Sustainability Barometer | Analytics/UX | Active at 48/91 with 43 open. Option A makes TypeScript/Supabase canonical and Python scoring offline-only; P1 NEW 10–12 close ownership, concatenated-season identity, complete paginated league/player reads, bounded fail-fast writes, write-chunk telemetry, and the exact scheduled-chain runbook | Depends on A-SUST and B-CRON-NST NEW 61; orchestration/distribution/retro, API/UI, broader observability, and versioning work remains |
...
| `tasks/TASKS/three-pillars-analytics/sustainability/tasks-prd-sustainability-barometer.md` | task list | A-SUST / B-SUST-BAR / B-SUST-AUD | 91 checkbox rows; 48 verified and 43 open after scheduled-pipeline completeness remediation |
