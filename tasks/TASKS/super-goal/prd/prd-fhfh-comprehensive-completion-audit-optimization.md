...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 87/132 with 45 open. NEW 80/90/94–96 are published through exact checkpoint `f30cdea5226f10b6097ff5531ce71b03d79af5c9`, superseding shared schedule-hook checkpoint `c80f4b193209512a6318f009faceeebd9866215e`; control-only NEW 93 is also closed and shared real-date NEW 89 is verified locally. One bounded persisted-start-date authority serves the player API, canonical projection runner, cron-facing projection route, and both detail pages; explicit selected-date seasons cannot silently fall back to current season, diagnostics are value-free, and the route fixture no longer emits false audit noise. NEW 91/97 preserve record-as-of/source-authority work; NEW 98/99 precede relocated-franchise NEW 92; NEW 100 retains the stale secondary catalog; NEW 81–87 preserve calendar ownership/performance, TeamStatsPage route/season, and hook error/overfetch/readiness work; NEW 76/77 remain separate quick-header findings. NEW 7/19–20/26/40–42/45/50/62–64/66/76–77/81–87/91–92/97–100 and broader image/hook/noise/toolchain/integrated work remain | Process NEW 91 + NEW 97, then NEW 98 + NEW 99 before NEW 92; continue NEW 100 and calendar/page/hook rows by dependency |
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 132 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, TeamDashboard, schedule/Forge, and historical team-source findings; 87/132 verified; NEW 7/19–20/26/40–42/45/50/62–64/66/76–77/81–87/91–92/97–100 and broader image/hook/noise/toolchain/integrated work remain open |
