...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 99/142 with 43 open. Historical updater/reader/route/dependency/fixture NEW 98/99/102/103/106 and writer authority/quarantine fixture NEW 104/108 are published. Relocated-franchise schedule identity and Forge weekly-context NEW 92/109/110 are locally verified pending publication; existing-row production repair NEW 105 and all-seasons relocation audit NEW 107 remain separate, and NEW 100/101 retain catalog/SoS ownership. NEW 7/19–20/26/40–42/45/50/62–64/66/76–77/81–87/100–101/105/107 and broader image/hook/noise/toolchain/integrated work remain | Publish NEW 92/109/110; retain NEW 105/107 as separate production/history work and continue NEW 100/101 by dependency |
...
B-CLEAN relocated-schedule identity/context local closure update (2026-07-22): NEW 92/109/110 close through one strict resolver that preserves canonical current UTA/68 inputs while selecting exact 2023–24 ARI/53, 2024–25 UTA/59, and 2025–26+ UTA/68 sources. The Forge API returns validated resolved-season source/canonical identity; detail and dashboard consumers separate fallback projection dates from requested schedule dates, mask stale responses, and share selected-season weekly games/off-night context. Wrong-era, cross-season, nonparticipant, duplicate-inventory, DST, empty/pending, fallback, and first-render boundaries are covered. Nine focused files/158 tests, full TypeScript, zero-error scoped lint, clean new-file formatting, baseline-aware legacy formatting, and diff integrity pass. B-CLEAN is 99/142 with 43 open; global parity is 4,214/4,834 with 620 open = 87.17% complete / 12.83% open. P2 is 133/108; NEW 105/107 remain separately held.
