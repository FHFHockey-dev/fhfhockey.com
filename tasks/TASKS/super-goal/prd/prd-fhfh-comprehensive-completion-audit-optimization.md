...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-drm-refactor.md` | task list | B-DRM | missing pair repaired; 77 rows, 31 architecture/correctness/request-state/aggregate-reader/base-pagination/stable-hook/explicit-state/wrapper-inventory/Option-A/exact-card-scope/stale-reset/typed-raw/strict-reduction/boundary/named-conflict/durable-terminal/ACL/FK/production-migration/deployed-auth/inventory/first-adoption/position-integrity rows verified; NEW 20/22–29/32–33/37–39/41/49–51 remain across credential, transaction, production, history, schedule, backlog, provenance, and audit gates; P2 NEW 13–16/37/41/51 remain |
