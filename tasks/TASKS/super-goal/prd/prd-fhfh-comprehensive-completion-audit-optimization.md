...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 113/143 with 30 open. Historical team identity, TeamScheduleCalendar, TeamStatsPage, useTeamSchedule, and PowerPlayCombos NEW 62/64 are locally complete. PowerPlay now terminates unresolved-season states, preserves exact source game/team/season identity through historical fallback, roster, and history, and fails closed on current-only optional context for historical sources. Existing-row production repair NEW 105 and all-seasons relocation audit NEW 107 remain separate. NEW 7/19–20/26/40–42/45/50/63/66/105/107 and broader image/hook/noise/toolchain/integrated work remain | Select the largest dependency-coherent non-strategy cleanup batch; retain trueGoalieValue, lint-policy, production, and broad-history boundaries |
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 143 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, TeamDashboard, schedule/Forge, historical team-source/context, exact-season SoS, calendar ownership, TeamStatsPage/useTeamSchedule lifecycle, and PowerPlay source-season findings; 113/143 verified; NEW 7/19–20/26/40–42/45/50/63/66/105/107 and broader image/hook/noise/toolchain/integrated work remain open |
