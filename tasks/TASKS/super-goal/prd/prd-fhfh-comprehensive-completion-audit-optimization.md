...
| B-SUST-BAR | Sustainability Barometer | Analytics/UX | Active at 49/92 with 43 open. P1 NEW 10–12 close canonical ownership, identity, complete reads, bounded writes, telemetry, and runbook work; QA 8.6 closes from 247,024/247,024 finite in-range production scores. P1 NEW 13 owns the integer-versus-fractional score-format/version boundary | Depends on A-SUST and B-CRON-NST NEW 61; orchestration/distribution/retro, API/UI, broader observability, versioning, and score-format strategy remain |
...
| `tasks/TASKS/three-pillars-analytics/sustainability/tasks-prd-sustainability-barometer.md` | task list | A-SUST / B-SUST-BAR / B-SUST-AUD | 92 checkbox rows; 49 verified and 43 open after production score-range/format audit |
