...
| B-SUST-BAR | Sustainability Barometer | Analytics/UX | Active at 45/90 with 45 open. Owner-approved Option A closes parents 1.0/3.0 and P1 NEW 10: TypeScript/Supabase is canonical, Python scoring is offline-only with production operations fail closed, and complete paginated prior reads now use correct concatenated-season identity. P1 NEW 11 is discovered and closed in the same checkpoint | Depends on A-SUST; canonical prior foundation now precedes remaining pipeline/API/UI/observability/versioning work |
...
| `tasks/TASKS/three-pillars-analytics/sustainability/tasks-prd-sustainability-barometer.md` | task list | A-SUST / B-SUST-BAR / B-SUST-AUD | 90 checkbox rows; 45 verified and 45 open after Option-A ownership/prior remediation |
