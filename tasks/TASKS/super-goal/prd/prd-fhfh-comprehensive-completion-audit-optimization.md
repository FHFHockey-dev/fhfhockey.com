...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 75/110 with 35 open. NEW 59 removes dead fabricated goalie ranks, NEW 67 enforces canonical pre-query team/season identity, and NEW 78 reconciles the current NEW 55 summary status; exact checkpoint `3970fa3b63f7cdda6a543e4440a3fad03d7e6ee6` publishes the eight-path closure with fresh local/tracking/live equality. The focused TeamDashboard file passes 23/23; full TypeScript, zero-error/zero-warning scoped lint, Prettier, exact dead/partial-parse searches, diff integrity, parity, and independent review pass. NEW 76/77 preserve separately owned TeamStatsPage quick-header formatting and request-lifecycle defects. NEW 7/19–20/26/40–42/45/50/60–66/76–77 and broader image/hook/noise/toolchain/integrated work remain | Continue shared schedule-hook NEW 60/61/65 before separately registered TeamStatsPage NEW 77/76 and active Forge consumer verification; keep NEW 45/50 separate and hold NEW 20 plus dependent NEW 40/41 for a material lint/toolchain strategy checkpoint |
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 110 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, migrated-logo/TeamLeaders, TeamDashboard season/request/data/identifier identity, and TeamStatsPage standings discoveries; 75/110 verified; NEW 7/19–20/26/40–42/45/50/60–66/76–77 and broader image/hook/noise/toolchain/integrated work remain open |
