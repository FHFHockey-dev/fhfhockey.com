...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 108/143 with 35 open. Historical team identity and TeamScheduleCalendar NEW 81/82 are published. TeamStatsPage NEW 76/77/83/84 is locally complete through exact route identity, one persisted page season, stale-safe header ownership, and truthful ordinal/unavailable output. Existing-row production repair NEW 105 and all-seasons relocation audit NEW 107 remain separate. NEW 7/19–20/26/40–42/45/50/62–64/66/85–87/105/107 and broader image/hook/noise/toolchain/integrated work remain | Retain NEW 105/107 as separate production/history work and continue hook NEW 85–87 by dependency |
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 143 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, TeamDashboard, schedule/Forge, historical team-source/context, exact-season SoS, calendar ownership, and TeamStatsPage identity/lifecycle findings; 108/143 verified; NEW 7/19–20/26/40–42/45/50/62–64/66/85–87/105/107 and broader image/hook/noise/toolchain/integrated work remain open |
