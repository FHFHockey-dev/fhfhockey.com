...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 111/143 with 32 open. Historical team identity, TeamScheduleCalendar NEW 81/82, and TeamStatsPage NEW 76/77/83/84 are published. useTeamSchedule NEW 85–87 is locally complete through exact selects, stable diagnostics/public copy, and progressive core readiness. Existing-row production repair NEW 105 and all-seasons relocation audit NEW 107 remain separate. NEW 7/19–20/26/40–42/45/50/62–64/66/105/107 and broader image/hook/noise/toolchain/integrated work remain | Retain NEW 105/107 as separate production/history work and audit PowerPlayCombos NEW 62/64 next |
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 143 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, TeamDashboard, schedule/Forge, historical team-source/context, exact-season SoS, calendar ownership, TeamStatsPage identity/lifecycle, and schedule-hook readiness findings; 111/143 verified; NEW 7/19–20/26/40–42/45/50/62–64/66/105/107 and broader image/hook/noise/toolchain/integrated work remain open |
