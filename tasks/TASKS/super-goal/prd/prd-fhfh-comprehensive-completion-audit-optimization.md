...
B-CLEAN TeamScheduleCalendar local closure update (2026-07-22): NEW 81/82 remove the calendar's duplicate team-stats/WGO/summary, games, and standings owners. Parent `useTeamSchedule` returns one expanded exact standings row alongside games with existing identity masking; the calendar's sole WGO owner uses exact columns, deterministic pagination, nullable-row normalization, synchronous team/season masking, unmount ownership, and stable error state. Home/away derives from parent games and dated opponent strength masks by exact request identity. Three focused files/57 tests, full TypeScript, zero-error scoped lint with two pre-existing dependency warnings, new-file formatting, baseline-aware legacy formatting, and diff integrity pass. B-CLEAN is 104/143 with 39 open; global parity is 4,219/4,835 with 616 open = 87.26% complete / 12.74% open. Severity is P0 15/10, P1 120/91, P2 133/110, and P3 21/20.
