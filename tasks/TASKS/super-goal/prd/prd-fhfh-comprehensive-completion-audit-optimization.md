...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 47/76. Prior cache/history/generated-state containment remains verified. The baseline/ownership and corrected semantic-accessibility slice closes base 1.0–2.3, verification 6.1/6.4, and NEW 18/21/24/27–39/43–44: native headers retain `aria-sort`, labeled buttons own sorting, all three day-switch views use a stable included-state name, arrow direction matches the ARIA state, repeated Enter/Space is canceled without extra callbacks, clipped/forced-colors focus remains visible, and parent propagation is render-safe. NEW 21 removes the original four unused directives and concretely justifies two active shift-chart suppressions; its four-page strict lint is 0 errors/6 unrelated warnings, one homepage test and full TypeScript pass. NEW 43 corrects historical publication labeling. NEW 44 records both current lint denominators: the baseline-compatible directory invocation is 1,499 files/0 errors/127 warnings (64 hooks, 59 raw images, four anonymous defaults, zero ARIA), while explicit JS/JSX/TS/TSX coverage is the extension-complete core at 1,500/0/129 (64 hooks, 61 raw images, four anonymous defaults, zero ARIA); the sole delta is `components/PoissonDistributionChart.jsx` and its two image warnings. Only the stable five-to-zero ARIA cluster is compared like-for-like with the 1,497-file/132-warning directory snapshot. NEW 7/19–20/22–23/25–26/40–42 and remaining hook/image/noise/toolchain/integrated-verification work stay open | Continue at wrapper/fallback correctness; hold NEW 20 and dependent NEW 40/41 for a material lint/toolchain strategy checkpoint |
...
Historical scheduler/generated-state publication evidence: exact checkpoint `36b3c38bf1db495b411b64fdf5dc8545ca9b434a` publishes the fail-closed 84-job cross-provider scheduler inventory, shared runtime-budget evidence, NEW 54/55 validation, B-CRON-NST NEW 61 discovery, and B-CLEAN NEW 13–17 forward generated-state containment. A normal push and fresh fetch proved local/tracking/live `octoberBranch` equality with zero divergence; no provider owner, schedule, deployment, database, or credential changed. Exact B-CLEAN NEW 21/43/44 checkpoint `11c51736c764b3df7b2d0da7920c93c0f2a91337` now supersedes its recency and is published with the same normal-push equality proof.
...
B-CLEAN stale-suppression update (2026-07-22): NEW 21 closes the original four-item representative cohort through directive-only removal and concrete justification of two active shift-chart omissions. Four-page strict lint reports zero errors/unused directives and six unrelated warnings; one homepage test, full TypeScript, JS syntax, and diff integrity pass. The expanded core inventory leaves 37 policy-dependent unused directives under NEW 40; out-of-core hook unknown-rule/two-unused drift remains NEW 41; and the three pages' pre-existing whole-file Prettier mismatch remains NEW 42. Final review closes NEW 43's stale publication label and NEW 44's exact lint-count correction. B-CLEAN is 47/76 with the same 29 implementation/strategy/formatting rows open.
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 76 current rows after containment, warning/accessibility/suppression, and final evidence-correction discoveries; 47/76 verified after final three-view semantic, bounded stale-directive, publication-label, and exact lint-count work; NEW 7/19–20/22–23/25–26/40–42 and broader hook/image/noise/toolchain/integrated work remain open |
