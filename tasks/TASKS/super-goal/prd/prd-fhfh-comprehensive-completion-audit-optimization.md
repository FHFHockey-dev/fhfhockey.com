...
| B-SUST-BAR | Sustainability Barometer | Analytics/UX | Active at 51/94 with 43 open. P1 NEW 10–12 close canonical ownership, identity, complete reads, bounded writes, telemetry, and runbook work; QA 8.5/8.6/8.8 close protected health, finite score-range proof, and operational-field documentation. P1 NEW 13 owns score format; NEW 14 owns API/window taxonomy; NEW 15 owns canonical version/config provenance | Depends on A-SUST and B-CRON-NST NEW 61; orchestration/distribution/retro, remaining API/UI, broader observability, versioning, and score/API strategy remain |
| B-SUST-AUD | Sustainability/trends audit | Analytics | Active at 2/42 with 40 open. Canonical incremental audit report now owns the reusable worksheet, terminology requirements, family index, evidence/finding registers, and dependency order; tracked-file inventory/classification is next | Depends on A-SUST and recovered trends scope; B-SUST-BAR NEW 13–15 remain explicit upstream decision boundaries |
...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 123/143 with 20 open. Historical team identity, TeamScheduleCalendar, TeamStatsPage, useTeamSchedule, PowerPlayCombos NEW 62/64, image-pilot/NEW 45/50, and base duplicate-ownership/architecture-boundary rows 5.1/5.4 are complete. The image pilot has a tracked local team fallback, shared trusted Stats headshots with exact dimensions and bounded fallback, explicit raw/SVG ownership, and zero named nonexistent default paths. Base 5.2 remains coupled to NEW 40/41; existing-row production repair NEW 105 and all-seasons relocation audit NEW 107 remain separate. NEW 7/19–20/26/40–42/63/66/105/107 and broader hook/noise/toolchain/integrated work remain | Select the next dependency-coherent non-strategy cleanup batch; retain trueGoalieValue, lint-policy, production, and broad-history boundaries |
...
B-DRM current-localhost revalidation (2026-07-22; no count change): clean authoritative receipt `f19647c300d0b912acdad87039d3617306b41e90` compiled the 2,042-module `/drm` route and served two HTTP-200 responses. The owner-reported relationship-overage stack was traced to stale shared-checkout commit `8ad7329e9`, before NEW 60's whole-game containment. Browser automation was unavailable, so the remaining checkpoint is an owner visual/error-overlay check; prior production-backed NEW 60 closure remains valid.
...
B-CLEAN writer-authority publication update (2026-07-22): exact 12-path checkpoint `773beb7ce429cca482348fa8d02e8dea2ab4a52b` publishes NEW 104/108 through a guarded normal non-force push. Fresh parent equality at `ffb5ffc42e041e16c4a409a6810bb76c6301041e`, exact staged scope, generated/cache/binary/size/value-free and integrity gates, 3 files/33 tests with zero stderr, full TypeScript, syntax checks, one-ahead/zero-behind proof, and post-push local/tracking/live equality pass with a clean isolated checkout.

B-CLEAN relocated-schedule identity discovery update (2026-07-22): NEW 92 review registers P2 same-root child NEW 109 before API remediation. The player projection API drops persisted source team identity and the detail page guesses from current names, so genuine 53/ARI and 59/UTA rows cannot reach strict canonical UTA/68 schedule selection. B-CLEAN is 96/141 with 45 open; global parity is 4,211/4,833 with 622 open = 87.13% complete / 12.87% open. P2 stays 133/107 because NEW 109 is not a separate severity root. Raw `/forge/team/ARI` remains unsupported by design and no active producer was evidenced; NEW 107 retains broader historical relocation scope.

B-CLEAN historical weekly-context discovery update (2026-07-22): continued NEW 92 review registers P2 same-root child NEW 110 before remediation. The weekly player schedule-context helper drops historical source IDs 53/59 because it resolves only current `teamsInfo`; both player detail and the dashboard `TopAddsWeekScheduleBridge` consume it, while the rail also lacks structured canonical projection identity. This removes games/off-night context and alters the week opportunity score across both surfaces. B-CLEAN is 96/142 with 46 open; global parity is 4,211/4,834 with 623 open = 87.11% complete / 12.89% open. P2 remains 133/107 because NEW 110 is part of NEW 92's already-counted root; NEW 107 still owns earlier and broader relocation history.

B-CLEAN relocated-schedule identity/context publication update (2026-07-22): NEW 92/109/110 close at exact checkpoint `0ada0b3d7ac31c22fb9d9cccf310ba2ec9ba492b` through one strict resolver that preserves canonical current UTA/68 inputs while selecting exact 2023–24 ARI/53, 2024–25 UTA/59, and 2025–26+ UTA/68 sources. The Forge API returns validated resolved-season source/canonical identity; detail and dashboard consumers separate fallback projection dates from requested schedule dates, mask stale responses, and share selected-season weekly games/off-night context. Wrong-era, cross-season, nonparticipant, duplicate-inventory, DST, empty/pending, fallback, and first-render boundaries are covered. Nine focused files/158 tests, full TypeScript, zero-error scoped lint, clean new-file formatting, baseline-aware legacy formatting, diff integrity, guarded normal push, and fresh equality pass. B-CLEAN is 99/142 with 43 open; global parity is 4,214/4,834 with 620 open = 87.17% complete / 12.83% open. P2 is 133/108; NEW 105/107 remain separately held.

B-CLEAN canonical SoS publication update (2026-07-22): NEW 100/101 remove the stale secondary TeamLandingPage catalog and bind `statsPlaceholder` to one latest-started persisted season through deterministic exact-`season_id` pagination and canonical current membership. Canonical ID/name/abbreviation flows directly to rendering; mixed ARI/53, UHC/59, and UTA/68 regression evidence produces exactly one current Mammoth row. Same-root NEW 111 exposes the weekly helper's existing non-null runtime guard to strict TypeScript. Two focused files/12 tests, full TypeScript, scoped lint with zero errors and three pre-existing image warnings, formatting, and diff integrity pass. Exact checkpoint `a62b60e97f6491902ae0c4bdbe2839c0e2a84b5a` is published with fresh local/tracking/live equality. B-CLEAN is 102/143 with 41 open; global parity is 4,217/4,835 with 618 open = 87.22% complete / 12.78% open. Severity is P0 15/10, P1 120/90, P2 133/109, and P3 21/20.

B-CLEAN TeamScheduleCalendar publication update (2026-07-22): NEW 81/82 remove the calendar's duplicate team-stats/WGO/summary, games, and standings owners. Parent `useTeamSchedule` returns one expanded exact standings row alongside games with existing identity masking; the calendar's sole WGO owner uses exact columns, deterministic pagination, nullable-row normalization, synchronous team/season masking, unmount ownership, and stable error state. Home/away derives from parent games and dated opponent strength masks by exact request identity. Three focused files/57 tests, full TypeScript, zero-error scoped lint with two pre-existing dependency warnings, new-file formatting, baseline-aware legacy formatting, and diff integrity pass. Exact checkpoint `8d61f29b4dd5aa1ef683a4e064beeedd5be6d99f` is published with fresh local/tracking/live equality. B-CLEAN is 104/143 with 39 open; global parity is 4,219/4,835 with 616 open = 87.26% complete / 12.74% open. Severity is P0 15/10, P1 120/91, P2 133/110, and P3 21/20.

B-CLEAN TeamStatsPage local closure update (2026-07-22): NEW 76/77/83/84 close locally. SSR rejects inherited or noncanonical route keys before any query. The newest persisted summary season owns the page label, header, shots, dashboard, and schedule. One request-identity-owned header hook clears prior state, stops stale/unmounted work before every continuation, settles empty/error deterministically with stable public copy and one value-free diagnostic, and preserves nullable standings ranks. One teen-safe formatter renders ordinary, teen, and unavailable values. Two focused files/6 tests, full TypeScript, zero-error scoped lint with one pre-existing image warning, new-file formatting, baseline-aware page formatting, and diff integrity pass. B-CLEAN is 108/143 with 35 open; global parity is 4,223/4,835 with 612 open = 87.34% complete / 12.66% open. Severity is P0 15/10, P1 120/92, P2 133/113, and P3 21/20. The next dependency-eligible local group is hook NEW 85–87; NEW 105/107 remain separate production/history boundaries.

B-CLEAN TeamStatsPage publication receipt (2026-07-22): exact checkpoint `b023aeab9e57d263b5c3ea4f73a454a2d370b979` publishes NEW 76/77/83/84's four implementation/test paths and six synchronized controls. Exact ten-path staging, generated/cache/binary/value-free and diff-integrity gates, two files/6 tests, full TypeScript, zero-error scoped lint, formatting, one-ahead/zero-behind proof, normal non-force push, and fresh local/tracking/live equality pass.

B-CLEAN schedule-hook local closure update (2026-07-22): NEW 85–87 close locally. The core games and score queries select only consumed fields; the already-exact standings query remains bounded to one latest row. A core failure produces one stable public error and one fixed value-free diagnostic. Core games publish immediately with `loading=false` before deferred score/standings enrichment; optional errors preserve usable games and emit fixed provider-value-free warnings. Five consumer files/79 tests, a focused 51-test rerun, full TypeScript, zero-error scoped lint, formatting, and diff integrity pass. B-CLEAN is 111/143 with 32 open; global parity is 4,226/4,835 with 609 open = 87.40% complete / 12.60% open. Severity is P0 15/10, P1 120/92, P2 133/116, and P3 21/20.

B-CLEAN schedule-hook publication receipt (2026-07-22): exact checkpoint `2ba29106c48c18d0ffb8dd18cfa583143aeeefaf` publishes NEW 85–87's hook/test paths and six synchronized controls. Exact eight-path staging, generated/cache/binary/value-free and diff-integrity gates, five files/79 tests plus the focused 51-test rerun, full TypeScript, zero-error scoped lint, formatting, one-ahead/zero-behind proof, normal non-force push, and fresh local/tracking/live equality pass.

B-CLEAN PowerPlay publication receipt (2026-07-22): exact checkpoint `76e9b5d4d6bf0e521af9651c72748ace12fe2797` publishes NEW 62/64's five implementation/test paths and six synchronized controls. Exact 11-path text-only staging, generated/cache/binary/size/value-free and diff-integrity gates, two files/14 tests, full TypeScript, zero-error scoped lint, formatting, one-ahead/zero-behind proof, normal non-force push, and fresh local/tracking/live equality pass.

B-CLEAN image-pilot local closure update (2026-07-22): base 4.0/4.3/4.4/6.0/6.2/6.3 and P2 NEW 45/50 close locally. One validated helper and tracked FHFH asset replace every named nonexistent team-logo default across active callers and the quarantined Forge card; TopMovers and D3 own bounded raw/SVG fallbacks. Three Stats leaderboards now share safe local/three-host headshot validation, exact 168×168 dimensions, CMS/local fallback, identity reset, and terminal exhaustion. Five files/25 tests, full TypeScript, zero-error scoped lint with one pre-existing Trends hook warning, clean new/shared formatting, baseline-aware legacy formatting, exact fallback/raw-owner scans, React review, and diff integrity pass. B-CLEAN is 121/143 with 22 open; global parity is 4,236/4,835 with 599 open = 87.61% complete / 12.39% open. Severity is P0 15/10, P1 120/92, P2 133/120, and P3 21/20.

B-CLEAN image-pilot publication receipt (2026-07-22): exact checkpoint `b648a7e812ef2c2145a182b50047e6c78e42fea2` publishes the 14 implementation/test paths and six synchronized controls. Exact 20-path text-only staging, generated/cache/binary/size/value-free and diff-integrity gates, five files/25 tests, full TypeScript, zero-error scoped lint with one pre-existing warning, clean new/shared formatting, one-ahead/zero-behind proof, normal non-force push, and fresh local/tracking/live equality pass.
...
| `tasks/TASKS/three-pillars-analytics/sustainability/tasks-prd-sustainability-barometer.md` | task list | A-SUST / B-SUST-BAR / B-SUST-AUD | 94 checkbox rows; 51 verified and 43 open after operations/version audit |
...
| `tasks/TASKS/three-pillars-analytics/sustainability/tasks-prd-sustainability-trends-audit.md` | task list | A-SUST / B-SUST-BAR / B-SUST-AUD | 42 checkbox rows; 2 verified and 40 open after worksheet/glossary initialization |
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 143 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, TeamDashboard, schedule/Forge, historical team-source/context, exact-season SoS, calendar ownership, TeamStatsPage/useTeamSchedule lifecycle, PowerPlay source-season, residual image-pilot findings, and base duplicate-ownership/architecture-boundary reconciliation; 123/143 verified; base 5.2/5.3, NEW 7/19–20/26/40–42/63/66/105/107, and broader hook/noise/toolchain/integrated work remain open |

B-CLEAN low-risk-noise reconciliation update (2026-07-22): base 5.1 and 5.4 close from the accumulated implementation record. Persisted-season selection, season-aware schedule identity, trusted headshot/fallback sources, and validated local logo paths are centralized only across identical owners, while unlike ownership remains explicit. Every completed cleanup slice is a bounded behavior/validation/presentation repair; no data-fetch, cache, bundle, or component architecture replacement was introduced. Base 5.2 remains open with NEW 40/41 pending the explicit residual debug-versus-operational log and no-console/toolchain disposition. B-CLEAN is 123/143; global parity is 4,238/4,835 = 87.65% complete.

B-SUST-BAR source/audit repair (2026-07-22): corrected the stale `0/8` registry claim to the canonical 37/89 source state and imported the malformed 1.0 parent plus P1 NEW 10. Parents 2.0/4.0 close from 28 current focused tests and Python compilation; conceptual-only 1.7 and stub-backed 3.2–3.4 reopen. The authoritative production baseline lacks four draft tables, current TypeScript uses `sustainability_priors`/`sustainability_player_priors`, and the legacy Python adapter also targets absent aggregate and barometer columns. Dependency order is canonical owner/schema decision → exact adapter/migration/runtime proof → pipeline/API/UI/observability/versioning. Global parity is 4,236/4,837 = 87.57% complete; no external state changed.

B-SUST-BAR Option-A ownership/prior remediation (2026-07-22): the owner-selected TypeScript/Supabase contract is now explicit and fail closed. The legacy Python DB adapter is removed after its sole unrelated connection consumer moved to a domain-neutral helper; Python scoring remains offline while persistence, incremental, snapshot, run-log, lock, and retro paths reject activation. Canonical prior reads fully range-paginate ordered league/current-player sources, batch selected IDs, and fetch all three complete NHL seasons. NEW 11 fixes concatenated-season arithmetic (`20252026` → `20242025` → `20232024`). Live catalog evidence proves exact tables/columns, composite keys, barometer uniqueness/indexes, 22 league-prior rows, 5,152 player-prior rows, and 940/1,042/924 source rows across the three seasons. Twenty-one Python and fourteen TypeScript pagination/prior tests, full TypeScript, scoped lint, compilation, and diff integrity pass. B-SUST-BAR is 45/90; global parity is 4,244/4,838 = 87.72% complete. No schema, data, provider, or deployment mutation occurred.

B-SUST-BAR scheduled-pipeline completeness remediation (2026-07-22): P1 NEW 12 closes the active pipeline's implicit league-reference page cap and oversized single-write risks. The ordered skill-league population now range-paginates to exhaustion; player-prior, window-z, score, projection, and trend-band writes share fail-fast batches capped at 400 rows; core bulk routes report write-chunk counts. The existing runbook now records the exact scheduled chain, idempotent retry identity, structured prerequisite/failure behavior, B-CRON-NST NEW 61 ownership dependency, Python offline boundary, and absent distribution/retro semantics. Twenty-four focused tests, full TypeScript, zero-error scoped lint with three pre-existing anonymous-default warnings, formatting, and diff integrity pass. Source 5.3/5.10 and NEW 12 close; B-SUST-BAR is 48/91 and global parity is 4,247/4,839 = 87.77%. No schema, data, provider, or deployment mutation occurred.

B-SUST-BAR production score-range/format audit (2026-07-22): a bounded value-free production aggregate proves all 247,024 persisted `s_100` rows are finite and within [0,100], with minimum 0 and maximum 100, closing source 8.6 alongside current clipped/invalid-input guardrail tests. The same audit registers open P1 NEW 13: 215,250 rows are fractional, including 34,636/34,944 rows from the last 14 days, although the source PRD and completed 4.7 specify integer formatting. Exact zero/hundred rows all satisfy the documented raw-probability thresholds. Runtime semantics remain unchanged pending an explicit version/history decision. B-SUST-BAR is 49/92; global parity is 4,248/4,840 = 87.77%. No data or deployment mutation occurred.

B-SUST-BAR health/API contract audit (2026-07-22): protected GET-only `/api/internal/sustainability/health` now returns exact counts and latest snapshot dates for the three canonical output tables and fails closed on read errors, closing 8.5 with focused tests and static gates. P1 NEW 14 records that existing single-window player, upcoming-projection, entity-sandbox, and dashboard-trends routes use `l3/l5/l10/l20` and do not implement the source's joined `GAME/G5/G10/STD` summary or exact filter/pagination/cache/auth-components contract. The recorded dependency order requires an explicit taxonomy/route-compatibility decision before 6.1–6.7. B-SUST-BAR is 50/93; global parity is 4,249/4,841 = 87.77%. No live API, data, or deployment mutation occurred.

B-SUST-BAR operations/version audit (2026-07-22): source 8.8 closes after the canonical runbook records every common scheduled-response timing/run/work/diagnostic/failure field, the persisted `cron_job_audit` mapping, nullable counter semantics, terminal success interpretation, bounded payloads, and prohibited secret values. P1 NEW 15 records that active `sustainability_scores` and `sustainability_player_priors` lack first-class model/config columns; score JSON carries string v2/hash metadata, while the draft-only barometer table has a conflicting integer version contract. No schema or writer change is allowed before a canonical version/backfill decision. B-SUST-BAR is 51/94; global parity is 4,250/4,842 = 87.77%. No production mutation occurred.
