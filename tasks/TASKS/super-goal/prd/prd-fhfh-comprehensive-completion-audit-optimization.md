...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 80/120 with 40 open. NEW 60/61/65/79/88 are locally closed through truthful season state, exact primitive fallback, canonical team/season identity, complete request ownership/empty masking, and valid-cached-data precedence. One focused hook file/31 tests, full TypeScript, zero-error/zero-warning scoped lint, Prettier, diff integrity, and two independent reviews pass. Exact checkpoint `3970fa3b63f7cdda6a543e4440a3fad03d7e6ee6` remains the latest published implementation until this hook checkpoint is guarded and pushed. NEW 80–87 preserve separate Forge date/season, calendar ownership/performance, TeamStatsPage route/season, and hook error/overfetch/readiness work; NEW 76/77 remain separate quick-header findings. NEW 7/19–20/26/40–42/45/50/62–64/66/76–77/80–87 and broader image/hook/noise/toolchain/integrated work remain | Guardedly publish NEW 60/61/65/79/88, then order active Forge/date NEW 80, calendar NEW 81/82, TeamStatsPage NEW 83/84/77/76, and hook contract NEW 85–87 by dependency; keep NEW 45/50 separate and NEW 20 plus dependent NEW 40/41 strategy-held |
...
Historical scheduler/generated-state publication evidence: exact checkpoint `36b3c38bf1db495b411b64fdf5dc8545ca9b434a` publishes the fail-closed 84-job cross-provider scheduler inventory, shared runtime-budget evidence, NEW 54/55 validation, B-CRON-NST NEW 61 discovery, and B-CLEAN NEW 13–17 forward generated-state containment. A normal push and fresh fetch proved local/tracking/live `octoberBranch` equality with zero divergence; no provider owner, schedule, deployment, database, or credential changed. Exact B-CLEAN NEW 21/43/44 checkpoint `11c51736c764b3df7b2d0da7920c93c0f2a91337`, wrapper/stats checkpoint `d5cc06cf57c26ac59f5ff9b5db1de8bf1e67f313`, migrated-logo/TeamLeaders checkpoint `a1948f78baa16797a29ae98bf0c7796782efc2db`, TeamDashboard season/request checkpoint `3e173f290f5ff4b1c8a4ac9accde3c56cd090d5c`, and data-identity checkpoint `47d90df8491fa9ac948a123498d4f475cfa2cf9b` subsequently superseded that recency. Exact TeamDashboard identifier/dead-state checkpoint `3970fa3b63f7cdda6a543e4440a3fad03d7e6ee6` is now the latest B-CLEAN implementation publication with the same guarded normal-push equality proof.
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 120 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, migrated-logo/TeamLeaders, TeamDashboard identity, and schedule/caller/page findings; 80/120 verified; NEW 7/19–20/26/40–42/45/50/62–64/66/76–77/80–87 and broader image/hook/noise/toolchain/integrated work remain open |
