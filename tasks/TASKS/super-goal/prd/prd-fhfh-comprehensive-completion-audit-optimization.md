...
| B-SUST-BAR | Sustainability Barometer | Analytics/UX | Active source reconciliation at 37/89 with 52 open. Configuration and pure rolling/scoring parents 2.0/4.0 pass 28 focused tests plus Python compilation. Malformed/conceptual schema claims and stub-backed canonical prior fetch/write claims are reopened; P1 NEW 10 records Python-adapter versus authoritative Supabase/TypeScript ownership drift | Depends on A-SUST; canonical schema/owner decision precedes pipeline/API/UI work |
...
| `tasks/TASKS/three-pillars-analytics/sustainability/tasks-prd-sustainability-barometer.md` | task list | A-SUST / B-SUST-BAR / B-SUST-AUD | 89 checkbox rows; 37 verified and 52 open after source/audit repair |
