...
| B-SUST-BAR | Sustainability Barometer | Analytics/UX | Active at 50/93 with 43 open. P1 NEW 10–12 close canonical ownership, identity, complete reads, bounded writes, telemetry, and runbook work; QA 8.5/8.6 close the protected health surface and finite in-range score proof. P1 NEW 13 owns integer-versus-fractional score format; P1 NEW 14 owns canonical API/window taxonomy and route compatibility | Depends on A-SUST and B-CRON-NST NEW 61; orchestration/distribution/retro, remaining API/UI, broader observability, versioning, and score/API strategy remain |
...
| `tasks/TASKS/three-pillars-analytics/sustainability/tasks-prd-sustainability-barometer.md` | task list | A-SUST / B-SUST-BAR / B-SUST-AUD | 93 checkbox rows; 50 verified and 43 open after health/API contract audit |
