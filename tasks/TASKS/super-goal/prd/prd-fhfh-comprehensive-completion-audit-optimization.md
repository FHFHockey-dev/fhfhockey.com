...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 86/128 with 42 open. NEW 80/90/94–96 are published through exact checkpoint `f30cdea5226f10b6097ff5531ce71b03d79af5c9`, superseding shared schedule-hook checkpoint `c80f4b193209512a6318f009faceeebd9866215e`; control-only NEW 93 is also closed. One bounded persisted-start-date authority now serves the player API, canonical projection runner, cron-facing projection route, and both detail pages; explicit selected-date seasons cannot silently fall back to current season, diagnostics are value-free, and the route fixture no longer emits false audit noise. NEW 89/91/92 preserve separate invalid-date, record-as-of, and relocated-franchise findings; NEW 81–87 preserve calendar ownership/performance, TeamStatsPage route/season, and hook error/overfetch/readiness work; NEW 76/77 remain separate quick-header findings. NEW 7/19–20/26/40–42/45/50/62–64/66/76–77/81–89/91–92 and broader image/hook/noise/toolchain/integrated work remain | Process shared real-date NEW 89 before record-as-of NEW 91 and relocated-franchise NEW 92, then continue calendar NEW 81/82, TeamStatsPage NEW 83/84/77/76, and hook NEW 85–87 by dependency |
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 128 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, migrated-logo/TeamLeaders, TeamDashboard identity, and schedule/caller/page findings; 86/128 verified; NEW 7/19–20/26/40–42/45/50/62–64/66/76–77/81–89/91–92 and broader image/hook/noise/toolchain/integrated work remain open |
