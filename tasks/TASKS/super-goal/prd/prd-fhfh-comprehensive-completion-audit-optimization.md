...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 80/120 with 40 open. NEW 60/61/65/79/88 are published through exact checkpoint `c80f4b193209512a6318f009faceeebd9866215e`, closing truthful season state, exact primitive fallback, canonical team/season identity, complete request ownership/empty masking, and valid-cached-data precedence. The combined season/schedule-hook group passes two files/35 tests, full TypeScript, zero-error/zero-warning scoped lint, Prettier, diff integrity, exact value-free publication scope, and independent review. NEW 80–87 preserve separate Forge date/season, calendar ownership/performance, TeamStatsPage route/season, and hook error/overfetch/readiness work; NEW 76/77 remain separate quick-header findings. NEW 7/19–20/26/40–42/45/50/62–64/66/76–77/80–87 and broader image/hook/noise/toolchain/integrated work remain | Audit and process active Forge/date NEW 80, then calendar NEW 81/82, TeamStatsPage NEW 83/84/77/76, and hook contract NEW 85–87 by dependency; keep NEW 45/50 separate and NEW 20 plus dependent NEW 40/41 strategy-held |
