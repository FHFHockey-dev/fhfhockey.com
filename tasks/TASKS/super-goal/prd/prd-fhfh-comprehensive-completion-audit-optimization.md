...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 72/107 with 35 open. NEW 57/58/68–75 close locally through selected-season date identity, deterministic request-start/empty replacement, settled render gating, terminal goalie/ranking copy, truthful mode/ordinal/rate formatting, future-window no-request behavior, finite zero-schedule workload, and unavailable missing-detail positions. The focused file passes 14/14; full TypeScript, zero-error scoped lint with the same one pre-existing parent warning, Prettier, diff integrity, parity, and independent review pass. NEW 7/19–20/26/40–42/45/50/59–67 and broader image/hook/noise/toolchain/integrated work remain | Complete remaining TeamDashboard NEW 59/67, then shared schedule-hook NEW 60/61/65 before active Forge consumer verification; keep NEW 45/50 separate and hold NEW 20 plus dependent NEW 40/41 for a material lint/toolchain strategy checkpoint |
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 107 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, migrated-logo/TeamLeaders, and TeamDashboard season/request/data-identity work; 72/107 verified; NEW 7/19–20/26/40–42/45/50/59–67 and broader image/hook/noise/toolchain/integrated work remain open |
