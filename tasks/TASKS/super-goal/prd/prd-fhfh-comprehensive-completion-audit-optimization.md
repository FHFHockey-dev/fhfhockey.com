...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 121/143 with 22 open. Historical team identity, TeamScheduleCalendar, TeamStatsPage, useTeamSchedule, PowerPlayCombos NEW 62/64, and image-pilot/NEW 45/50 are locally complete. The image pilot now has a tracked local team fallback, shared trusted Stats headshots with exact dimensions and bounded fallback, explicit raw/SVG ownership, and zero named nonexistent default paths. Existing-row production repair NEW 105 and all-seasons relocation audit NEW 107 remain separate. NEW 7/19–20/26/40–42/63/66/105/107 and broader hook/noise/toolchain/integrated work remain | Select the next dependency-coherent non-strategy cleanup batch; retain trueGoalieValue, lint-policy, production, and broad-history boundaries |
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 143 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, TeamDashboard, schedule/Forge, historical team-source/context, exact-season SoS, calendar ownership, TeamStatsPage/useTeamSchedule lifecycle, PowerPlay source-season, and residual image-pilot findings; 121/143 verified; NEW 7/19–20/26/40–42/63/66/105/107 and broader hook/noise/toolchain/integrated work remain open |
