...
B-DRM dependency update (2026-07-20): NEW 31/36/40/42/44/45 and the temporary-branch rollback/concurrency/security/audit gate are complete. The disposable branch was cleaned and deleted. Remaining execution resumes at production-gated NEW 20/22–30/32–33/35/37–39/41, with NEW 29 retaining broader history/xG/TOI compatibility and B-CRON-NST NEW 60 separately owning the authoritative `analytics` baseline.
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-drm-refactor.md` | task list | B-DRM | missing pair repaired; 71 rows, 18 architecture/correctness/request-state/aggregate-reader/Option-A/exact-card-scope/stale-reset/typed-raw/strict-reduction/boundary/named-conflict/durable-terminal/ACL rows verified; NEW 20 and NEW 22–33/35–41/45 remain across credential, transaction, history, schedule, backlog, provenance, FK coverage, auth, and audit gates; P2 NEW 13–16/37/41/45 remain |
