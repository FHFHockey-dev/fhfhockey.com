...
| B-CLEAN | Code cleanup/warning reduction | Maintenance | Active at 104/143 with 39 open. Historical team identity through exact-season SoS NEW 100/101/111 is published. TeamScheduleCalendar single-owner games/standings/WGO data flow NEW 81/82 is locally complete. Existing-row production repair NEW 105 and all-seasons relocation audit NEW 107 remain separate. NEW 7/19–20/26/40–42/45/50/62–64/66/76–77/83–87/105/107 and broader image/hook/noise/toolchain/integrated work remain | Retain NEW 105/107 as separate production/history work and continue TeamStatsPage NEW 83/84/77/76 by dependency |
...
| `tasks/TASKS/dead-code-cleanup/tasks-prd-cleanup-tasks.md` | task list | B-CLEAN | missing pair repaired; 143 current rows after containment, warning/accessibility/suppression, evidence correction, wrapper/fallback, TeamDashboard, schedule/Forge, historical team-source/context, exact-season SoS, and calendar ownership findings; 104/143 verified; NEW 7/19–20/26/40–42/45/50/62–64/66/76–77/83–87/105/107 and broader image/hook/noise/toolchain/integrated work remain open |
