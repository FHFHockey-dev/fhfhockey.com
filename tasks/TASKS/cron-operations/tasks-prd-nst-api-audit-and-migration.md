...
- `tasks/TASKS/xg-model/nst-migration/nst-direct-caller-inventory.md` - Working inventory of direct NST callers, indirect references, and legacy URL touchpoints discovered during task `1.1`.
- `tasks/TASKS/xg-model/nst-migration/nst-config-contract.md` - Canonical NST host, secret, auth, redaction, and environment contract established in task `2.1`.
...
- `tasks/TASKS/schema-docs/supabase-context/nst-team-tables-schemas.md` - Existing NST team-table schema notes that may help verify parity expectations.
...
- `tasks/TASKS/three-pillars-analytics/underlying-stats/player-underlying-stats-runbook.md` - Example operator runbook style for validation and troubleshooting guidance.
