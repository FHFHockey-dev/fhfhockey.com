...
- `web/lib/cron/cronInventory.ts` - Shared parser and loader for deriving the scheduled cron inventory from `tasks/TASKS/cron-operations/cron-schedule.md` with stable chronological ordering.
...
- [x] 1.0 Inventory and classify every scheduled cron job from `tasks/TASKS/cron-operations/cron-schedule.md`
  - [x] 1.1 Parse every scheduled entry in `tasks/TASKS/cron-operations/cron-schedule.md` and build a normalized inventory of job name, time slot, method, URL or SQL body, and dependency position.
...
- [x] 4.0 Build the benchmark runner and audit capture workflow
  ...
  - [x] 4.2 Implement chronological execution from earliest to latest using the normalized inventory from `tasks/TASKS/cron-operations/cron-schedule.md`.
...
- [x] 6.0 Redesign `tasks/TASKS/cron-operations/cron-schedule.md` using measured results
  ...
  - [x] 6.6 Update the timeline summary and the detailed cron blocks in `tasks/TASKS/cron-operations/cron-schedule.md` so the documented schedule matches the measured redesign exactly.
