...
- [ ] NEW 9.4 **P1 Production Start Chart deployment drift:** exact commit `589b0241d3b81682e54cac5327e5f53078ad3ba4` is READY/Production as `dpl_2DyH68oEiUhfsakGfRcHMAFdmumA`, but the populated `2026-03-14` repeat returned 500 because two Yahoo compatibility views were published before their migrations. Local recovery restores the deployed legacy readers and passes the 8-file/50-test cross-consumer cohort plus TypeScript/lint. Keep open for an authorized recovery publication and successful populated 1440×900/390-class repeat; do not trigger a standalone hosted build (updated 2026-07-30).
