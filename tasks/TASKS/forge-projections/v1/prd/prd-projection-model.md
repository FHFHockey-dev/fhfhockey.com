...
> Schema source of truth: `tasks/TASKS/forge-projections/context/forge-tables.md` (keep PRD aligned with that file).
...
- `tasks/TASKS/forge-projections/context/forge-tables.md` - Supabase table definitions for FORGE outputs.
