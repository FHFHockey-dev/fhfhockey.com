...
28. The audit must inspect the relevant scheduling guidance in [cron-schedule.md](/Users/tim/Code/fhfhockey.com/tasks/TASKS/cron-operations/cron-schedule.md).
...
6. The audit must use the current cron guidance in [cron-schedule.md](/Users/tim/Code/fhfhockey.com/tasks/TASKS/cron-operations/cron-schedule.md) as the baseline, then call out drift or gaps.
