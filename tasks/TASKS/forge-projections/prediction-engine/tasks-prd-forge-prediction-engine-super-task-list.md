...
- A: `tasks/TASKS/forge-projections/v1/prd/prd-projection-model.md` - FORGE player/team/goalie projection engine.
- B: `tasks/TASKS/sko-charts/prd-sko-charts.md` - sKO player evaluation/prediction charts and model transparency.
- C: `tasks/TASKS/three-pillars-analytics/rolling-player-metrics/prd/prd-rolling-player-averages.md` - rolling player metric foundation.
- D: `tasks/TASKS/forge-projections/dashboard-health/tasks-forge-dashboard-component-remediation.md` - FORGE dashboard trust, freshness, ownership, and component remediation.
- E: `tasks/TASKS/forge-projections/ecosystem-audits/tasks-prd-forge-trends-combo-project.md` - combined FORGE/Trends dashboard.
- F: `tasks/TASKS/three-pillars-analytics/sustainability/tasks-prd-sustainability-barometer.md` - sustainability barometer pipeline and UI.
- G: `tasks/TASKS/three-pillars-analytics/sustainability/tasks-prd-sustainability-model.md` - sustainability feature/model/API layer.
- H: `tasks/TASKS/forge-projections/v1/tasks-skater-forge.md` - skater-specific FORGE projection improvement.
- I: `tasks/TASKS/three-pillars-analytics/sustainability/sustainability-trends-plan.md` - volatility/elasticity trend bands.
- J: `tasks/TASKS/nhl-game-prediction-model/tasks-prd-nhl-game-prediction-model.md` - NHL game prediction model, serving, scoring, health.
- K: `tasks/TASKS/nhl-game-prediction-model/tasks-prd-nhl-game-prediction-roster-sos-model.md` - roster-adjusted and SoS-adjusted game prediction improvements.
...
- [x] 0.0 Establish the canonical prediction-engine contract
  ...
  - [x] 0.2 Update stale source references, especially `tasks/TASKS/forge-projections/context/forge-tables.md` -> `tasks/TASKS/forge-projections/context/forge-tables.md`.
...
- [x] 1.0 Stabilize upstream source freshness and pipeline health
  - [x] 1.1 Verify the active cron order in `tasks/TASKS/cron-operations/cron-schedule.md` against the real dependency graph in `web/lib/rollingForgePipeline.ts`.
