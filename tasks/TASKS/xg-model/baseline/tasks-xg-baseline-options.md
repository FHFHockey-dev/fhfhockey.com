...
- `tasks/TASKS/xg-model/baseline/xg-training-materialization-decision.md` - Decision record that baseline datasets will be stored as versioned artifacts rather than generated only on demand.
