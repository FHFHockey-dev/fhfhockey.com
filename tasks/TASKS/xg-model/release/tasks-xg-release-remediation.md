...
- `tasks/TASKS/xg-model/nhl-api-foundation/validation-checklist.md` - Formal checklist the remediation work must satisfy before training can begin.
...
- The final remediation package must produce a complete formal validation artifact with the metadata required by `tasks/TASKS/xg-model/nhl-api-foundation/validation-checklist.md`.
