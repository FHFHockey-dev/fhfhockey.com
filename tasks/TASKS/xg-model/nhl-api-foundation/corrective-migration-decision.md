...
- `tasks/TASKS/xg-model/nhl-api-foundation/live-schema-drift-audit.md`
...
- the live catalog audit in `tasks/TASKS/xg-model/nhl-api-foundation/live-schema-drift-audit.md` found no remaining phase-1 drift for:
  - columns
  - constraints
  - indexes
  - trigger behavior
