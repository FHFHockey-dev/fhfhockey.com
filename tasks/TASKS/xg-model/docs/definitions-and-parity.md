...
- A version bump must be accompanied by documentation updates in this file and, when relevant, updates in `tasks/TASKS/xg-model/nhl-api-foundation/metric-parity-map.md`.
