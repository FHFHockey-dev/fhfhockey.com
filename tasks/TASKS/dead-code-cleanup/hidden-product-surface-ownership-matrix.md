...
- Five legacy routes across four families retain bookmark-compatible behavior but are no longer ambiguous: their shared visible quarantine notice, noindex metadata, and exact canonical links are explicit. Redirect/removal remains separately approval-gated.
...
- No route was redirected or removed; no navigation item, sitemap, rewrite, deployment, or external system changed.
