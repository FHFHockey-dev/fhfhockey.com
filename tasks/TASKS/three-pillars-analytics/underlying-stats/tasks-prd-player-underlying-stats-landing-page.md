...
- `tasks/TASKS/three-pillars-analytics/underlying-stats/player-underlying-stats-runbook.md` - End-of-project consolidation target for a cleanup-friendly runbook, TL;DR, and component elevator pitch after temporary planning artifacts are merged or removed.
...
- [x] 7.0 Consolidate temporary planning artifacts into one cleanup-friendly runbook and remove redundant markdown clutter
  - [x] 7.1 Create `tasks/TASKS/three-pillars-analytics/underlying-stats/player-underlying-stats-runbook.md` as the final runbook / TL;DR / component elevator pitch for future maintainers.
