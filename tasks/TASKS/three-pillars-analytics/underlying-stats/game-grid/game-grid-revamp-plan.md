...
To align with the **FHFHockey Design System** (`tasks/TASKS/rules/fhfh-styles.md`), we will inject the "Tron meets Moneyball" vibe into this high-density dashboard.
