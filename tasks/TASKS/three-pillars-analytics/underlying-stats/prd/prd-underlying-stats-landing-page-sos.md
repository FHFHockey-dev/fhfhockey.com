...
- the upper page layout is looser than the intended table-first data-page archetype in `tasks/TASKS/rules/fhfh-styles.md`
...
4. Keep the landing page visually consistent with `tasks/TASKS/rules/fhfh-styles.md`, `web/styles/vars.scss`, and `web/styles/_panel.scss`.
...
24. The system must not introduce a one-off local visual system that conflicts with `tasks/TASKS/rules/fhfh-styles.md`.
...
- The page should be treated as a table-heavy data page under `tasks/TASKS/rules/fhfh-styles.md`, not as a hero-style landing page.
