...
2. Rewrite [tasks/TASKS/rules/fhfh-styles.md](/Users/tim/Code/fhfhockey.com/tasks/TASKS/rules/fhfh-styles.md) into a canonical prompt-style design system that is explicit enough for Codex to restyle future pages from that file alone.
...
The end state should allow a future prompt such as “Please re-style `[page]` per the rules in `tasks/TASKS/rules/fhfh-styles.md`” to be actionable without extra interpretation.

## Goals

1. Establish a single canonical style guide in [tasks/TASKS/rules/fhfh-styles.md](/Users/tim/Code/fhfhockey.com/tasks/TASKS/rules/fhfh-styles.md) that defines FHFH visual rules in prompt-ready language, with enough specificity for Codex to apply them consistently.
...
5. As a future Codex agent, I want [tasks/TASKS/rules/fhfh-styles.md](/Users/tim/Code/fhfhockey.com/tasks/TASKS/rules/fhfh-styles.md) to tell me what to do for each element type, page archetype, and token decision so I can execute a restyle prompt consistently.
...
4. The resulting [tasks/TASKS/rules/fhfh-styles.md](/Users/tim/Code/fhfhockey.com/tasks/TASKS/rules/fhfh-styles.md) must be rewritten as a Codex-oriented prompt document rather than a loose brand note.
...
25. After approval, sandbox elements may either remain as canonical showcase examples or be removed, but the decision and intended long-term pattern must be documented in [tasks/TASKS/rules/fhfh-styles.md](/Users/tim/Code/fhfhockey.com/tasks/TASKS/rules/fhfh-styles.md).
...
34. The rewritten [tasks/TASKS/rules/fhfh-styles.md](/Users/tim/Code/fhfhockey.com/tasks/TASKS/rules/fhfh-styles.md) must be sufficient for a future Codex prompt of the form “Please re-style `[page]` per the rules in `tasks/TASKS/rules/fhfh-styles.md`.”
...
4. Validate that any examples written into [tasks/TASKS/rules/fhfh-styles.md](/Users/tim/Code/fhfhockey.com/tasks/TASKS/rules/fhfh-styles.md) reflect tokens and mixins that exist in the codebase.
...
1. [tasks/TASKS/rules/fhfh-styles.md](/Users/tim/Code/fhfhockey.com/tasks/TASKS/rules/fhfh-styles.md) becomes a complete enough prompt document that a future Codex restyle request can be executed from that file alone.
