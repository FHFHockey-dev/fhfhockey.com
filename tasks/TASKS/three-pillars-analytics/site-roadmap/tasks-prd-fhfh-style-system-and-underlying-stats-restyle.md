...
- `tasks/TASKS/rules/fhfh-styles.md` - Canonical prompt-style design system document to be rewritten with explicit rules, examples, approval guidance, and future Codex instructions.
...
- `tasks/TASKS/three-pillars-analytics/underlying-stats/UnderlyingStats_Audit.md` - Rendered audit and section-to-style-system mapping for the current `underlying-stats` landing surface.
...
- `tasks/TASKS/three-pillars-analytics/underlying-stats/PlayerStatsLanding_Audit.md` - Rendered audit for the player landing surface, including the explicit stylesheet clarification and section-to-archetype mapping.
- `tasks/TASKS/three-pillars-analytics/underlying-stats/PlayerStatsDetail_Audit.md` - Evaluation of the `[playerId]` route showing that it inherits the shared page module and documenting the decision to defer route-specific markup cleanup.
...
- `tasks/TASKS/draft-dashboard-yahoo/docs/DraftDashboard_Audit.md` - Existing audit notes that can be mined or updated when translating dashboard observations into canonical style rules.
...
- [x] 2.0 Rewrite `tasks/TASKS/rules/fhfh-styles.md` into a complete Codex-oriented style system with explicit element-by-element rules and SCSS examples
  - [x] 2.1 Restructure `tasks/TASKS/rules/fhfh-styles.md` so it reads as a prompt-ready system document instead of a loose aesthetic memo.
...
- [x] 3.0 Normalize shared design tokens and panel primitives in `vars.scss` and `_panel.scss`, and cross-verify all referenced variables exist
  ...
  - [x] 3.5 Cross-verify that every token and mixin referenced in `tasks/TASKS/rules/fhfh-styles.md`, the sandbox page, and the restyled production pages actually exists and compiles cleanly.
...
- [x] 4.0 Build `cssTestingGrounds` as the canonical sandbox and approval surface for reusable UI primitives
  ...
  - [x] 4.5 Add labels or annotations inside the sandbox so each showcased element clearly maps to the corresponding section in `tasks/TASKS/rules/fhfh-styles.md`.
...
- [x] 6.0 Define and document the component-by-component signoff workflow, missing-element gap process, and ongoing maintenance rules linking docs, sandbox, tokens, and production
  ...
  - [x] 6.4 Add maintenance guidance stating that changes to canonical styling must stay synchronized across `tasks/TASKS/rules/fhfh-styles.md`, shared tokens/mixins, sandbox examples, and production implementations.
