...
- `tasks/TASKS/three-pillars-analytics/prd-three-pillars-analytics.md` - Source PRD for the three-pillar implementation plan.
...
- `tasks/TASKS/rules/process-task-list.mdc` - Task-processing rule set clarified so true external manual steps are distinct from routine terminal work Codex can execute directly.
...
- `tasks/TASKS/three-pillars-analytics/nhl-edge/nhl-edge-stats-api.md` - Starting point for NHL Edge endpoint expansion during launch implementation.
