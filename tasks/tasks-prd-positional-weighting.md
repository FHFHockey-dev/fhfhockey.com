...
- Follow `prd-positional-weighting.md`, `AGENTS.md`, and `mise-en-place.md`. Preserve the dirty checkout; do not commit, push, deploy, contact third parties, or alter purchases.
